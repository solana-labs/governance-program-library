...
use gpl_bonk_plugin::{state::*, SPL_TOKEN_STAKING_PROGRAM_ID};
...
impl RealmVoterTest {
    ...
    //     let data = anchor_lang::InstructionData::data(
    //         &gpl_bonk_plugin::instruction::CreateMaxVoterWeightRecord {},
    //     );

    //     let accounts = gpl_bonk_plugin::accounts::CreateMaxVoterWeightRecord {
    //         registrar: registrar_cookie.address,
    ...
    // ) -> Result<(), BanksClientError> {
    //     let data = anchor_lang::InstructionData::data(
    //         &gpl_bonk_plugin::instruction::ConfigureVoterWeights {
    //             max_voter_weight,
    //             realm_member_voter_weight,
    //         },
    //     );

    //     let accounts = gpl_bonk_plugin::accounts::ConfigureVoterWeights {
    //         registrar: registrar_cookie.address,
    ...
    //     let data = anchor_lang::InstructionData::data(
    //         &gpl_bonk_plugin::instruction::ConfigureGovernanceProgram { change_type },
    //     );

    //     let accounts = gpl_bonk_plugin::accounts::ConfigureGovernanceProgram {
    //         registrar: registrar_cookie.address,
    //         realm: registrar_cookie.account.realm,
    //         realm_authority: registrar_cookie.realm_authority.pubkey(),
