use anchor_lang::{AccountDeserialize, AccountSerialize, error, Owner, prelude::AccountInfo, require_eq, Result};
...
fn get_generic_voter_weight_record_data<'a, R: RegistrarBase<'a> + AccountSerialize + AccountDeserialize + Owner + Clone>(
    input_account: &'a AccountInfo,
    registrar: &'a Account<R>,
) -> Result<GenericVoterWeightEnum> {
