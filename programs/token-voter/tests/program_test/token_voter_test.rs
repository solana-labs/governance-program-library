...
impl TokenVoterTest {
    ...
    pub async fn with_registrar_using_ix<F: Fn(&mut Instruction)>(
        ...
        let max_mints = 10;
        let data = anchor_lang::InstructionData::data(&token_voter::instruction::CreateRegistrar {
            max_mints,
        });

        let accounts = anchor_lang::ToAccountMetas::to_account_metas(
            &token_voter::accounts::CreateRegistrar {
    ...
    pub async fn with_voter_using_ix<F: Fn(&mut Instruction)>(
        ...
        let data = anchor_lang::InstructionData::data(
            &token_voter::instruction::CreateVoterWeightRecord {},
        );

        let accounts = token_voter::accounts::CreateVoterWeightRecord {
    ...
    pub async fn with_max_voter_weight_record_using_ix<F: Fn(&mut Instruction)>(
        ...
        let data = anchor_lang::InstructionData::data(
            &token_voter::instruction::CreateMaxVoterWeightRecord {},
        );

        let accounts = token_voter::accounts::CreateMaxVoterWeightRecord {
            registrar: registrar_cookie.address,
    ...
    pub async fn configure_mint_config_using_ix<F: Fn(&mut Instruction)>(
        ...
        let data =
            anchor_lang::InstructionData::data(&token_voter::instruction::ConfigureMintConfig {
                digit_shift,
            });

        let accounts = token_voter::accounts::ConfigureVotingMintConfig {
            registrar: registrar_cookie.address,
            realm: registrar_cookie.account.realm,
